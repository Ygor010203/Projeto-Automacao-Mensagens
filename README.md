...
\`\`\`bash
git clone https://github.com/Ygor010203/Projeto-Automacao-Mensagens.git
cd Projeto-Automacao-Mensagens
\`\`\`

Instale as dependências necessárias e configure suas variáveis de ambiente (chaves do Supabase e da Z-API) antes de executar.
